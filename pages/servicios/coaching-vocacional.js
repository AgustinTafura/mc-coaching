                                    ...
                                    <div className="row justify-content-center">
                                        <div className="col-md-12 col-lg-8">
                                            ...
                                            <p className="card-text mbr-regular mbr-black mbr-fonts-style display-77 text-center">
                                                ...
                                                <br/><br/>
                                                Por último, el Coaching Vocacional  acompaña a las personas a reconocer su estado actual y alcanzar ese estado al que desean llegar. Si estás interesado o interesada en saber más acerca de un proceso de Coaching Vocacional que te ayude a decidir tu futuro , no dudes en contactarte por <b><a style={{textDecoration: 'none', color:'unset'}} href="https://api.whatsapp.com/send?phone=5492244445189&amp;text=Hola+Marcela%21%0A%0AMe+gustaría+recibir+información+sobre+tus+servicios.%0A%0AMuchas+gracias+🤗&amp;type=phone_number&amp;app_absent=0">whatsapp</a></b> o por <b><a style={{textDecoration: 'none', color:'unset'}} href="mailto: info@marcelacaputo.com">mail</a></b> .
                                            </p>
                                        </div>
