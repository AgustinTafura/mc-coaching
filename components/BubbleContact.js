  ...
  useEffect(() => {
    ...
    const displayBubble = () => {
      if (window.scrollY >= 368) {
        contactBubble.style.opacity = 0.8
        contactBubble.classList.remove('d-none')
      } else {
