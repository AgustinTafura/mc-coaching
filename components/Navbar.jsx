                    ...
                    sections.map(section=>{
                      ...
                      return (
                        <li key={section.name} className="nav-item text-uppercase fw-normal dropdown">
                          <a className="nav-link link mbr-black text-black display-4 dropdown-toggle" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            {section.name}
                          </a>
                      ...
                      return ( 
                        <li key={section.name} className="nav-item text-uppercase fw-normal">
                          <a className="nav-link link mbr-black text-black display-4" aria-current="page" href={section.link}>{section.name}</a>
                        </li>
                      )
                    })
                  }
            ...
            {/* <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav nav-dropdown js-float-line" data-app-modern-menu="true">
                <li className="nav-item">
                  <a className="nav-link link mbr-black text-black display-4" href="index.html" aria-expanded="false">
                    HOME</a>
                </li>
                <li className="nav-item dropdown"><a
                    className="nav-link link mbr-black text-black dropdown-toggle display-4" href="https://mobirise.com"
                    aria-expanded="false" data-toggle="dropdown-submenu">
                    LIVE DEMO</a>
                  <div className="dropdown-menu"><a className="mbr-black text-black dropdown-item display-4"
                      href="courses.html" aria-expanded="false">Psychological Therapy</a><a
                      className="mbr-black text-black dropdown-item display-4" href="family.html"
                      aria-expanded="false">Family Therapy</a><a className="mbr-black text-black dropdown-item display-4"
                ...
                <li className="nav-item dropdown"><a
                  ...
                  <div className="dropdown-menu"><a className="mbr-black text-black dropdown-item display-4"
                      ...
                      className="mbr-black text-black dropdown-item display-4" href="content.html"
                      aria-expanded="false">Content / Accordions / Shop
                    </a><a className="mbr-black text-black dropdown-item display-4" href="pricing.html"
                      aria-expanded="false"> Pricing / Progress /
                      Video</a><a className="mbr-black text-black dropdown-item display-4" href="team.html"
                      aria-expanded="false">Contacts / Team / Maps</a><a
                      className="mbr-black text-black dropdown-item display-4" href="clients.html" aria-expanded="false">
                      Clients / Testimonials </a><a className="mbr-black text-black dropdown-item display-4"
                      href="forms.html" aria-expanded="false"> Forms / Footers</a></div>
                </li>
              </ul>
              <div className="navbar-buttons mbr-section-btn"><a className="btn btn-sm btn-primary display-4"
