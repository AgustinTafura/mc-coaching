                    ...
                    <div className="row justify-content-center">
                        ...
                        <div className="mbr-black col-md-6 col-lg-4">
                            <div className="content align-left mbr-white">
                                <h4 className="mbr-section-subtitle mbr-regular mbr-fonts-style display-44">UN POCO SOBRE MI</h4>
                                <h3 className="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-22">
                                    Biografía y Experiencias
                                </h3>
                                <p className="mbr-text pb-3 mbr-regular mbr-fonts-style display-77">
                                    Hola! Mi nombre es <b>Marcela Caputo. </b>
                                    Nací en Las Flores, una pequeña
                                    localidad del interior de la Provincia de Buenos Aires.
                                    <br/>
                                </p>
                                <p className="mbr-text pb-3 mbr-regular mbr-fonts-style display-77">
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4 mx-auto mbr-form" data-form-type="formoid">
                            <div className="form-col" data-form-type="formoid">
                                ...
                                <div className="col-lg-12 col-md-12 col-sm-12">
                                    <h5 className="mbr-bold mbr-fonts-style pb-3 display-55" style={{color: 'var(--bs-secondary)'}}>
                                        Reserva una cita
                                    </h5>
                                </div>
                                <div className='pt-3'>
